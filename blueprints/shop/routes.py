...
from models import Product, Review, User  # ensure models are available
from database import db
from . import shop_bp
import models  # gives access to Review class inside Jinja
...
def product_page(product_id):
    ...
    # Pass `db` and `models` so Jinja can calculate AVG rating
